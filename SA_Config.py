...
class Config():
    ...
    predict_path ='./word2vec_data/pre.txt'
    ...
    model_state_dict_path='./word2vec_data/sentiment_analysis_model.pkl'# 训练模型保存的地址
    stop_words_path = './word2vec_data/stopword.txt'
    train_data_path = './word2vec_data/train_data.txt'
    val_data_path = './word2vec_data/val_data.txt'
    test_data_path = './word2vec_data/test_data.txt'
